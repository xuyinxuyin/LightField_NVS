...
def config_parser():
    ...
    parser.add_argument("--ckpt_path_2", type=str, default="",
                        help='ckpt_path_2 for comparison')
    ...
    parser.add_argument("--act", type=str, default='norm',
                        help='activation functions for MultiTypeFC')
    parser.add_argument("--so3", type=str, default="no_so3", help='near depth bound')
    parser.add_argument("--read_path", type=str, default="no_so3", help='near depth bound')
    parser.add_argument("--read_path_2", type=str, default="no_so3", help='near depth bound')
